...
@SpringBootTest
class MedBillProBackendApplicationTests {
...
public class Test {
    public static void main(String[] args) throws InterruptedException {
        ...
        fileInput.sendKeys("C:\\Users\\dell\\OneDrive\\Desktop\\DATA\\invoice.pdf");
        Thread.sleep(3000);
